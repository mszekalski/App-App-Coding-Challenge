...
export class Login2Page {
  ...
  processForm(): void {
    if (this.formLogin2.valid) {
      ...
      this.loginUserCall = this.configService
            ...
            if (status == 200) {
              if (data.message != "Invalid Credentials") {
                ...
                localStorage.setItem(
                  "profilePictureUri",
                  JSON.stringify(this.profilePictureUri)
                );
                ...
                this.userProvider
                  ...
                  .subscribe(
                    () => {
                      ...
                      this.uaProvider.registered().subscribe(
                        () => {
                        ...
                        if (
                          ...
                          if (appAllowed == "Invalid") {
                            this.showAlertMessage(
                              "Uh oh!",
                              "No active subscription found on this account, please subscribe to get one free appetizer redemption daily.",
                              ["OK"]
                            );
